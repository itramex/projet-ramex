...
export default function ProducteursList() {
  ...
  const [items, setItems] = useState<Producteur[]>([]);
  ...
  const fetchPage = useCallback(
    async (targetPage: number, replace: boolean) => {
      ...
      setError('');
      try {
        const response = await producteurService.list({
          page: targetPage,
          page_size: PAGE_SIZE,
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TextInput
          ...
          placeholder="Rechercher un nom, un village..."
        ...
        ListEmptyComponent={
          loading ? (
            ...
            <Text style={styles.empty}>
              {debouncedSearch
                ? 'Aucun producteur trouvé pour cette recherche.'
