...
const icons = { ArchiveBoxIcon, ArrowDownTrayIcon, ArrowPathIcon, ArrowRightOnRectangleIcon, ArrowUpTrayIcon, Bars3Icon, BookOpenIcon, BuildingOfficeIcon, CalendarIcon, ChartBarIcon, ChartBarSquareIcon, CheckBadgeIcon, CheckCircleIcon, CheckIcon, ChevronDownIcon, ChevronRightIcon, ClipboardDocumentListIcon, Cog6ToothIcon, CogIcon, CubeIcon, DocumentTextIcon, EnvelopeIcon, ExclamationTriangleIcon, EyeIcon, FunnelIcon, GiftIcon, GlobeAltIcon, HeartIcon, HomeIcon, InboxIcon, InformationCircleIcon, LightBulbIcon, LinkIcon, MagnifyingGlassIcon, MapIcon, MapPinIcon, MegaphoneIcon, PaperAirplaneIcon, PencilIcon, PhoneIcon, PlusIcon, RectangleGroupIcon, RectangleStackIcon, SparklesIcon, Square3Stack3DIcon, TrashIcon, TruckIcon, UserGroupIcon, UserIcon, UsersIcon, XCircleIcon, XMarkIcon };
